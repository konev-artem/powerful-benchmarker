...
import sys
sys.path.append('./powerful-benchmarker')

from src.powerful_benchmarker.barlow_twin_approach.barlow_twin_trainer import BarlowTwinTrainer
from src.powerful_benchmarker.barlow_twin_approach.barlow_twin_loss  import BarlowTwinLossAndTripletMarginLoss
...
if args.bayes_opt_iters > 0:
        from src.powerful_benchmarker.runners.bayes_opt_runner import BayesOptRunner
        args.reproductions = [int(x) for x in args.reproductions.split(",")]
        runner = BayesOptRunner
else:
        from src.powerful_benchmarker.runners.single_experiment_runner import SingleExperimentRunner
...
r.register("loss", BarlowTwinLossAndTripletMarginLoss)
r.register("trainer", BarlowTwinTrainer)
